...
class APITestExecutor:
    ...
    def _initialize_flags(self):
        ...
        self.test_setup_run = False
        self.test_teardown_run = False
    ...
    def _execute_test_step(self, test_step: Dict[str, Union[str, Any]], is_dynamic_check: bool = False):
        try:
            ...
            self.response_handler.process_and_store_results(response, test_step, self.test_cases_path, self.test_case_manager, execution_time, is_dynamic_check)
    ...
    def _execute_test_step_with_dynamic_checks(self, test_step: Dict[str, Union[str, Any]]) -> bool:
        try:
            ...
            self.response_handler.handle_validate_expectations_result(test_step, self.test_cases_path, self.test_case_manager,target_response, execution_time, validate_result)
            return True
        except Exception as e:
            logger.error(f"Failed to execute test step {test_step['TSID']}: {str(e)}")
            return False

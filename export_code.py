...
if __name__ == '__main__':
    exclude_scripts = ['export_code.py', 'export_html.py', 'gen_temp_default.py']  # Replace with your actual script names
    directory_to_search = '.'
    ...
    output_txt_file = 'output/collected_files_content.txt'
